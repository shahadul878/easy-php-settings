...
add_action(
	...
	function ( $hook ) {
		...
		wp_enqueue_style(
			...
			array(),
			defined( 'PLUGIN_TRACKER_PLUGIN_VERSION' ) ? PLUGIN_TRACKER_PLUGIN_VERSION : '1.2.0'
		);
	}
);
...
function tracker_integration_enqueue_offer_notice_assets() {
	...
	$version     = defined( 'PLUGIN_TRACKER_PLUGIN_VERSION' ) ? PLUGIN_TRACKER_PLUGIN_VERSION : '1.2.0';
	$offer       = $active['offer'];
